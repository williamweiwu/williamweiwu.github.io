...
for i_data =1:length(datasets)
    ...
    network(1:nodeNum + 1:end) = 0;
            ...
            for ik = 1:length(ks)
                ...
                for dense= 1:length(ratios)
                    ...
                    for iteration =1: iterations
                        ...
                        load(['parameters/',data,  '/', data, '.', num2str(ratios(dense)), '.',method, '.iteration.', num2str(iteration), '.k.', num2str(k),'.fingerprints.turn.', num2str(iturn),'.mat']);
        ...
        save(['parameters/', data, '.', method, '.results.mat'],  'auc', 'runtimes', 'elapsed','cpu', 'auc_mean', 'runtimes_mean', 'elapsed_mean','cpu_mean')
